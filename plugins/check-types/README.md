...
# @rmtc/plugin-check-types

A [TypeScript](https://www.typescriptlang.org/) type-checking plugin for [@rmtc/toolchain](https://github.com/rowanmanning/toolchain#readme). This validates types based on `jsconfig.json` but does not produce any output.
...
```sh
npm install --save-dev @rmtc/plugin-check-types
```
